...
public class KATDevice : MonoBehaviour {
    ...
    public CharacterController BusMove;
    #endregion
    ...
    public enum MovementStyleList { Translate, Velocity, Character }
    [HideInInspector]
        ...
        switch (Type)
        {
            case DeviceTypeList.KAT_WALK:
                ...
                if (target_Rig == null)
                    ...
                    else if (targetMoveObject.GetComponent<CharacterController>())
                    {
                        
                        MovementStyle = MovementStyleList.Character;
                        print("무브먼트 스타일 캐릭터 컨트롤러로 변경");
                    }
    ...
    void TargetTransform(MovementStyleList Type)
    {
        ...
        switch (Type)
        {
            ...
            #region Character
            case MovementStyleList.Character:

                BusMove.Move(targetRotateObject.forward / 100 * KATDevice_Walk.Instance.data_moveSpeed * KATDevice_Walk.Instance.data_moveDirection - new Vector3(0, 9.81f, 0) * Time.deltaTime);
                targetRotateObject.localEulerAngles = new Vector3(targetRotateObject.localEulerAngles.x, KATDevice_Walk.Instance.data_bodyYaw, targetRotateObject.localEulerAngles.z);
